...
Protocol state protocol-v1.7 (freeze tag protocol-v1.0), row D8. Run (UTC): 2026-09-17T10:39:27+00:00.
...
**FX lag = 84 days**, AICc -13.4326, ahead of the runner-up by 0.0334. Prewhitened CCF at that lag -0.0686 (screen rank 2). Ties are broken to the shorter lag at both stages, as the frozen row declares.

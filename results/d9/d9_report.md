...
Protocol state protocol-v1.6 (freeze tag protocol-v1.0), row D9. Run (UTC): 2026-08-26T03:32:43+00:00.
...
**search lag = 42 days**, AICc -23.5410, ahead of the runner-up by 2.9660. Prewhitened CCF at that lag -0.0724 (screen rank 1). Ties are broken to the shorter lag at both stages, as the frozen row declares.

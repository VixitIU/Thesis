...
Protocol state protocol-v1.7 (freeze tag protocol-v1.0; environment per D1 as frozen), rows D5 (selection) and D6 (fallback). Run (UTC): 2026-09-17T09:35:31+00:00.

Input: `C:\Users\New\Documents\IU work\Thesis\data\aligned_train.csv`; SHA-256 `4224fe90606f4a77e71dafadb99538a8ac878555a32805a48219f27cf7809313`.
...
6. error_action='ignore'; optimizer convergence logged per fit; maxiter = 500 (common numerical ceiling per the addendum of 17 September 2026; the full stepwise search was re-executed under this setting).

## Selection

Selected: **fourier_K1, ARIMA(0,1,2)(0,0,0)[7], no intercept** -- lowest AICc (-11.79) among visited fits passing Ljung-Box at lag 14 (p = 0.3396, df = 12, alpha = 0.05).

## Per-candidate stepwise winners (D5: 'record the resulting AICc')

| candidate | (p,q)(P,Q) | AICc | LB p (df) | LB pass |
|---|---|---|---|---|
| monthly | (3,1)(0,0) | 13.10 | 0.4859 (10) | yes |
| fourier_K1 | (0,2)(0,0) | -11.79 | 0.3396 (12) | yes |
| fourier_K2 | (0,2)(0,0) | -8.22 | 0.3469 (12) | yes |
| fourier_K3 | (0,2)(0,0) | -11.47 | 0.3940 (12) | yes |
| fourier_K4 | (0,2)(0,0) | -10.52 | 0.4085 (12) | yes |
| fourier_K5 | (0,2)(0,0) | -9.18 | 0.4049 (12) | yes |
| fourier_K6 | (0,2)(0,0) | -10.84 | 0.4106 (12) | yes |

## Counts

Candidates: 7. Visited valid fits (pooled): 118. LB-passing: 93. Optimizer non-converged: 0.
